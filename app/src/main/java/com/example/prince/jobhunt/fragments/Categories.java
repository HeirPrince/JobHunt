...
import com.example.prince.jobhunt.activities.MapsActivity;
...
public class Categories extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		new_list = v.findViewById(R.id.cat_list);
		...
		((Home)getActivity()).onSearch(new onSearchQueryListener() {
			...
			public void query(String query) {
				new_list.setAdapter(search_adapter);
		...
		return new FirestoreRecyclerAdapter<Job, JobHolder>(response) {
			...
			public JobHolder onCreateViewHolder(ViewGroup group, int i) {
				View view = LayoutInflater.from(group.getContext())
						.inflate(R.layout.layout_job_item_new, group, false);
	...
	public class JobHolder extends RecyclerView.ViewHolder {
		...
		public View apply, edit, applications, locate;
